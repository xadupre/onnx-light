...
/// Returns the seq(tensor(elem)) TensorType for scalar @p elem, or TensorType::kUndefined when
/// ONNX defines no such sequence type (low-precision float/int types cannot appear in a
/// Sequence).
TensorType SeqTypeOf(TensorType elem) {
  switch (elem) {
...
/// Returns the optional(tensor(elem)) TensorType for scalar @p elem, or
/// TensorType::kUndefined when ONNX defines no such optional type.
TensorType OptTypeOf(TensorType elem) {
  switch (elem) {
  case TensorType::kBool:
...
/// Returns the optional(seq(tensor(elem))) TensorType for scalar @p elem, or
/// TensorType::kUndefined when ONNX defines no such optional-sequence type.
TensorType OptSeqTypeOf(TensorType elem) {
  switch (elem) {
  case TensorType::kBool:
