...
#include "onnx_lib/version_converter/adapters/axis_input_to_attribute.h"
#include "onnx_lib/version_converter/adapters/batch_normalization_13_14.h"
#include "onnx_lib/version_converter/adapters/broadcast_backward_compatibility.h"
#include "onnx_lib/version_converter/adapters/broadcast_forward_compatibility.h"
#include "onnx_lib/version_converter/adapters/cast_9_8.h"
#include "onnx_lib/version_converter/adapters/clip_10_11.h"
#include "onnx_lib/version_converter/adapters/compatible.h"
#include "onnx_lib/version_converter/adapters/dropout_11_12.h"
#include "onnx_lib/version_converter/adapters/extend_supported_types.h"
#include "onnx_lib/version_converter/adapters/gemm_6_7.h"
#include "onnx_lib/version_converter/adapters/gemm_7_6.h"
#include "onnx_lib/version_converter/adapters/gridsample_19_20.h"
#include "onnx_lib/version_converter/adapters/group_normalization_20_21.h"
#include "onnx_lib/version_converter/adapters/group_normalization_21_20.h"
...
#include "onnx_lib/version_converter/adapters/resize_18_17.h"
#include "onnx_lib/version_converter/adapters/scan_8_9.h"
#include "onnx_lib/version_converter/adapters/scan_9_8.h"
#include "onnx_lib/version_converter/adapters/scatter_10_11.h"
#include "onnx_lib/version_converter/adapters/scatter_16_15.h"
#include "onnx_lib/version_converter/adapters/scatter_18_17.h"
#include "onnx_lib/version_converter/adapters/slice_9_10.h"
#include "onnx_lib/version_converter/adapters/softmax_12_13.h"
#include "onnx_lib/version_converter/adapters/softmax_13_12.h"
#include "onnx_lib/version_converter/adapters/split_12_13.h"
#include "onnx_lib/version_converter/adapters/split_13_12.h"
#include "onnx_lib/version_converter/adapters/split_17_18.h"
#include "onnx_lib/version_converter/adapters/sum_8_7.h"
#include "onnx_lib/version_converter/adapters/topk_9_10.h"
#include "onnx_lib/version_converter/adapters/transformers.h"
#include "onnx_lib/version_converter/adapters/type_restriction.h"
#include "onnx_lib/version_converter/adapters/upsample_6_7.h"
#include "onnx_lib/version_converter/adapters/upsample_8_9.h"
...
private:
  ...
  bool searchOpDomainMap(
      ...
      int64_t curr_version, int64_t step) const {
    bool up = step == 1;
  ...
  void assertDefaultDomain(const std::string &initial_domain,
    ...
    ONNX_ASSERTM((initial_domain.empty() || initial_domain == "ai.onnx") &&
  ...
  void convert_graph(const std::shared_ptr<Graph> &g, const OpSetID &initial_version,
  ...
  DefaultVersionConverter() {
    ...
    for (auto &[op_name, domain_map] : all_schemas) {
      ...
      if (default_versions != domain_map.end()) {
        ...
        if (min_version > 1) {
          registerAdapter(std::make_unique<NoPreviousVersionAdapter>(op_name, OpSetID(min_version),
                                                                     OpSetID(min_version - 1)));
        }
      }
    }
    ...
    std::vector<TensorProto_DataType> concat_unallowed_types = {
        TensorProto_DataType_INT32,  TensorProto_DataType_INT64, TensorProto_DataType_UINT32,
        TensorProto_DataType_UINT64, TensorProto_DataType_UINT8, TensorProto_DataType_UINT16,
        TensorProto_DataType_INT8,   TensorProto_DataType_INT16, TensorProto_DataType_STRING,
        TensorProto_DataType_BOOL};
    registerAdapter(std::make_unique<TypeRestriction>("Concat", OpSetID(4), OpSetID(3),
                                                      concat_unallowed_types));
    ...
    std::vector<TensorProto_DataType> int_unallowed_types = {
        TensorProto_DataType_UINT8,  TensorProto_DataType_UINT16, TensorProto_DataType_UINT32,
        TensorProto_DataType_UINT64, TensorProto_DataType_INT8,   TensorProto_DataType_INT16,
        TensorProto_DataType_INT32,  TensorProto_DataType_INT64};
    std::vector<TensorProto_DataType> neg_unallowed_types = {
        TensorProto_DataType_INT32, TensorProto_DataType_INT8, TensorProto_DataType_UINT16,
        TensorProto_DataType_INT64};
    registerAdapter(std::make_unique<TypeRestriction>("Add", OpSetID(6), OpSetID(5),
                                                      broadcast_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("Mul", OpSetID(6), OpSetID(5),
                                                      broadcast_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("Sub", OpSetID(6), OpSetID(5),
                                                      broadcast_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("Div", OpSetID(6), OpSetID(5),
                                                      broadcast_unallowed_types));
    registerAdapter(
        std::make_unique<TypeRestriction>("Abs", OpSetID(6), OpSetID(5), int_unallowed_types));
    registerAdapter(
        std::make_unique<TypeRestriction>("Neg", OpSetID(6), OpSetID(5), neg_unallowed_types));
    registerAdapter("BatchNormalization", 6, 5,
                    SetAttribute(kconsumed_inputs, std::vector<int64_t>({0, 0})));
    ...
    /******** 7 -> 6 ********/
    registerAdapter(
        std::make_unique<BroadcastBackwardCompatibility>("Add", OpSetID(7), OpSetID(6)));
    registerAdapter(
        std::make_unique<BroadcastBackwardCompatibility>("Div", OpSetID(7), OpSetID(6)));
    registerAdapter(
        std::make_unique<BroadcastBackwardCompatibility>("Mul", OpSetID(7), OpSetID(6)));
    registerAdapter(
        std::make_unique<BroadcastBackwardCompatibility>("Pow", OpSetID(7), OpSetID(6)));
    registerAdapter(std::make_unique<CompatibleAdapter>("PRelu", OpSetID(7), OpSetID(6)));
    registerAdapter(
        std::make_unique<BroadcastBackwardCompatibility>("Sub", OpSetID(7), OpSetID(6)));
    ...
    /******** 8 -> 7 ********/
    registerAdapter(
        std::make_unique<BroadcastBackwardCompatibility>("Max", OpSetID(8), OpSetID(7)));
    registerAdapter(
        std::make_unique<BroadcastBackwardCompatibility>("Min", OpSetID(8), OpSetID(7)));
    registerAdapter(
        std::make_unique<BroadcastBackwardCompatibility>("Mean", OpSetID(8), OpSetID(7)));
    ...
    /******** 9 -> 8 ********/
    registerAdapter(
        std::make_unique<CompatibleAdapter>("BatchNormalization", OpSetID(9), OpSetID(8)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("NonMaxSuppression", OpSetID(10), OpSetID(11)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ReduceLogSumExp", OpSetID(10), OpSetID(11)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ReduceSumSquare", OpSetID(10), OpSetID(11)));
    ...
    std::vector<TensorProto_DataType> equal_unallowed_types = {
        TensorProto_DataType_UINT8,   TensorProto_DataType_UINT16, TensorProto_DataType_UINT32,
        TensorProto_DataType_UINT64,  TensorProto_DataType_INT8,   TensorProto_DataType_INT16,
        TensorProto_DataType_FLOAT16, TensorProto_DataType_FLOAT,  TensorProto_DataType_DOUBLE};
    ...
    registerAdapter(std::make_unique<TypeRestriction>("Equal", OpSetID(11), OpSetID(10),
                                                      equal_unallowed_types));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ReduceLogSumExp", OpSetID(11), OpSetID(10)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ReduceSumSquare", OpSetID(11), OpSetID(10)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("BatchNormalization", OpSetID(11), OpSetID(12)));
    ...
    /******** 12 -> 11 ********/
    std::vector<TensorProto_DataType> maxpool_unallowed_types = {TensorProto_DataType_UINT8,
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("BatchNormalization", OpSetID(12), OpSetID(11)));
    registerAdapter(
        std::make_unique<TypeRestriction>("Clip", OpSetID(12), OpSetID(11), int_unallowed_types));
    registerAdapter(
        std::make_unique<TypeRestriction>("Min", OpSetID(12), OpSetID(11), int_unallowed_types));
    registerAdapter(
        std::make_unique<TypeRestriction>("Max", OpSetID(12), OpSetID(11), int_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("MaxPool", OpSetID(12), OpSetID(11),
                                                      maxpool_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("ReduceMax", OpSetID(12), OpSetID(11),
                                                      maxpool_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("ReduceMin", OpSetID(12), OpSetID(11),
                                                      maxpool_unallowed_types));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("DequantizeLinear", OpSetID(12), OpSetID(13)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("GatherElements", OpSetID(12), OpSetID(13)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("NegativeLogLikelihoodLoss", OpSetID(12), OpSetID(13)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("MeanVarianceNormalization", OpSetID(12), OpSetID(13)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("QuantizeLinear", OpSetID(12), OpSetID(13)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ReduceLogSumExp", OpSetID(12), OpSetID(13)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ReduceSumSquare", OpSetID(12), OpSetID(13)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ScatterElements", OpSetID(12), OpSetID(13)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("SoftmaxCrossEntropyLoss", OpSetID(12), OpSetID(13)));
    ...
    /******** 14 -> 15 ********/
    registerAdapter(
        std::make_unique<CompatibleAdapter>("BatchNormalization", OpSetID(14), OpSetID(15)));
    ...
    /******** 15 -> 16 ********/
    registerAdapter("RoiAlign", 15, 16,
                    SetAttribute(kcoordinate_transformation_mode, "output_half_pixel"));
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ScatterElements", OpSetID(15), OpSetID(16)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("GreaterOrEqual", OpSetID(15), OpSetID(16)));
    ...
    registerAdapter(
        std::make_unique<TypeRestriction>("Where", OpSetID(16), OpSetID(15), bfloat16_not_allowed));
    registerAdapter(std::make_unique<Scatter_16_15>("ScatterElements", OpSetID(16), OpSetID(15),
                                                    bfloat16_not_allowed));
    registerAdapter(std::make_unique<Scatter_16_15>("ScatterND", OpSetID(16), OpSetID(15),
                                                    bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Scan", OpSetID(16), OpSetID(15), bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("LessOrEqual", OpSetID(16), OpSetID(15),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("GreaterOrEqual", OpSetID(16), OpSetID(15),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("LeakyRelu", OpSetID(16), OpSetID(15),
                                                      bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("PRelu", OpSetID(16), OpSetID(15), bfloat16_not_allowed));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("OptionalGetElement", OpSetID(17), OpSetID(18)));
    registerAdapter(
        std::make_unique<CompatibleAdapter>("OptionalHasElement", OpSetID(17), OpSetID(18)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ScatterElements", OpSetID(17), OpSetID(18)));
    ...
    registerAdapter(
        std::make_unique<AxesAttributeToInput>("ReduceLogSum", OpSetID(17), OpSetID(18)));
    registerAdapter(
        std::make_unique<AxesAttributeToInput>("ReduceLogSumExp", OpSetID(17), OpSetID(18)));
    ...
    registerAdapter(
        std::make_unique<AxesInputToAttribute>("ReduceLogSum", OpSetID(18), OpSetID(17)));
    registerAdapter(
        std::make_unique<AxesInputToAttribute>("ReduceLogSumExp", OpSetID(18), OpSetID(17)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("DequantizeLinear", OpSetID(18), OpSetID(19)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("QuantizeLinear", OpSetID(18), OpSetID(19)));
    ...
    const std::vector<TensorProto_DataType> float8_unallowed_types = {
        TensorProto_DataType_FLOAT8E4M3FN, TensorProto_DataType_FLOAT8E4M3FNUZ,
        TensorProto_DataType_FLOAT8E5M2, TensorProto_DataType_FLOAT8E5M2FNUZ};
    ...
    registerAdapter(std::make_unique<TypeRestriction>("Constant", OpSetID(19), OpSetID(18),
                                                      float8_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("Cast", OpSetID(19), OpSetID(18),
                                                      float8_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("CastLike", OpSetID(19), OpSetID(18),
                                                      float8_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("DequantizeLinear", OpSetID(19), OpSetID(18),
                                                      float8_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("QuantizeLinear", OpSetID(19), OpSetID(18),
                                                      float8_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("Equal", OpSetID(19), OpSetID(18),
                                                      string_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("Identity", OpSetID(19), OpSetID(18),
                                                      float8_unallowed_types));
    registerAdapter(
    ...
    registerAdapter(std::make_unique<TypeRestriction>("Scan", OpSetID(19), OpSetID(18),
                                                      float8_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("Shape", OpSetID(19), OpSetID(18),
                                                      float8_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("Size", OpSetID(19), OpSetID(18),
                                                      float8_unallowed_types));

    /******** 19 -> 20 ********/
    registerAdapter(std::make_unique<AxisAttributeToInput>("DFT", OpSetID(19), OpSetID(20), 2, 1));
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ConstantOfShape", OpSetID(19), OpSetID(20)));
    ...
    registerAdapter(std::make_unique<TypeRestriction>("ConstantOfShape", OpSetID(20), OpSetID(19),
                                                      constant_of_shape_9_unallowed_types));
    const std::vector<TensorProto_DataType> is_nan_13_unallowed_types = {
        TensorProto_DataType_FLOAT8E4M3FN, TensorProto_DataType_FLOAT8E4M3FNUZ,
        TensorProto_DataType_FLOAT8E5M2, TensorProto_DataType_FLOAT8E5M2FNUZ};
    registerAdapter(std::make_unique<TypeRestriction>("IsNaN", OpSetID(20), OpSetID(19),
                                                      is_nan_13_unallowed_types));
    const std::vector<TensorProto_DataType> is_inf_10_unallowed_types = {
        ...
        TensorProto_DataType_FLOAT8E4M3FN, TensorProto_DataType_FLOAT8E4M3FNUZ,
        TensorProto_DataType_FLOAT8E5M2,   TensorProto_DataType_FLOAT8E5M2FNUZ};
    registerAdapter(std::make_unique<TypeRestriction>("IsInf", OpSetID(20), OpSetID(19),
                                                      is_inf_10_unallowed_types));
    registerAdapter(std::make_unique<AxisInputToAttribute>("DFT", OpSetID(20), OpSetID(19), 2, -2));
    const std::vector<TensorProto_DataType> reduce_min_max_18_unallowed_types = {
        TensorProto_DataType_BOOL};
    registerAdapter(std::make_unique<TypeRestriction>("ReduceMax", OpSetID(20), OpSetID(19),
                                                      reduce_min_max_18_unallowed_types));
    registerAdapter(std::make_unique<TypeRestriction>("ReduceMin", OpSetID(20), OpSetID(19),
                                                      reduce_min_max_18_unallowed_types));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ConstantOfShape", OpSetID(20), OpSetID(21)));
    registerAdapter(
        std::make_unique<CompatibleAdapter>("DequantizeLinear", OpSetID(20), OpSetID(21)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("QuantizeLinear", OpSetID(20), OpSetID(21)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("GroupNormalization", OpSetID(20), OpSetID(21)));

    /******** 21 -> 20 ********/
    const std::vector<TensorProto_DataType> q_dqmm_20_unallowed_types = {
        TensorProto_DataType_BFLOAT16, TensorProto_DataType_FLOAT16, TensorProto_DataType_UINT4,
        TensorProto_DataType_INT4};
    const std::vector<TensorProto_DataType> ir10_types_not_in_ir9 = {TensorProto_DataType_UINT4,
                                                                     TensorProto_DataType_INT4};
    ...
    registerAdapter(
        std::make_unique<TypeRestriction>("Cast", OpSetID(21), OpSetID(20), ir10_types_not_in_ir9));
    registerAdapter(std::make_unique<TypeRestriction>("CastLike", OpSetID(21), OpSetID(20),
                                                      ir10_types_not_in_ir9));
    registerAdapter(std::make_unique<TypeRestriction>("Constant", OpSetID(21), OpSetID(20),
                                                      ir10_types_not_in_ir9));
    registerAdapter(std::make_unique<TypeRestriction>("ConstantOfShape", OpSetID(21), OpSetID(20),
                                                      ir10_types_not_in_ir9));
    registerAdapter(std::make_unique<DequantizeLinear_21_20>());
    registerAdapter(std::make_unique<GroupNormalization_21_20>());
    registerAdapter(std::make_unique<TypeRestriction>("Flatten", OpSetID(21), OpSetID(20),
                                                      ir10_types_not_in_ir4));
    registerAdapter(std::make_unique<TypeRestriction>("Identity", OpSetID(21), OpSetID(20),
                                                      ir10_types_not_in_ir9));
    registerAdapter(
        std::make_unique<TypeRestriction>("If", OpSetID(21), OpSetID(20), ir10_types_not_in_ir9));
    registerAdapter(
        std::make_unique<TypeRestriction>("Loop", OpSetID(21), OpSetID(20), ir10_types_not_in_ir9));
    registerAdapter(
        std::make_unique<TypeRestriction>("Pad", OpSetID(21), OpSetID(20), ir10_types_not_in_ir4));
    registerAdapter(std::make_unique<TypeRestriction>("QLinearMatMul", OpSetID(21), OpSetID(20),
                                                      q_dqmm_20_unallowed_types));
    registerAdapter(std::make_unique<QuantizeLinear_21_20>());
    registerAdapter(std::make_unique<TypeRestriction>("Reshape", OpSetID(21), OpSetID(20),
                                                      ir10_types_not_in_ir9));
    registerAdapter(
        std::make_unique<TypeRestriction>("Scan", OpSetID(21), OpSetID(20), ir10_types_not_in_ir9));
    registerAdapter(std::make_unique<TypeRestriction>("Shape", OpSetID(21), OpSetID(20),
                                                      ir10_types_not_in_ir9));
    registerAdapter(
        std::make_unique<TypeRestriction>("Size", OpSetID(21), OpSetID(20), ir10_types_not_in_ir9));
    registerAdapter(std::make_unique<TypeRestriction>("Squeeze", OpSetID(21), OpSetID(20),
                                                      ir10_types_not_in_ir4));
    registerAdapter(std::make_unique<TypeRestriction>("Transpose", OpSetID(21), OpSetID(20),
                                                      ir10_types_not_in_ir9));
    registerAdapter(std::make_unique<TypeRestriction>("Unsqueeze", OpSetID(21), OpSetID(20),
                                                      ir10_types_not_in_ir4));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("RandomUniformLike", OpSetID(21), OpSetID(22)));
    registerAdapter(
        std::make_unique<CompatibleAdapter>("RandomNormalLike", OpSetID(21), OpSetID(22)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ThresholdedRelu", OpSetID(21), OpSetID(22)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("NegativeLogLikelihoodLoss", OpSetID(21), OpSetID(22)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("GlobalAveragePool", OpSetID(21), OpSetID(22)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("InstanceNormalization", OpSetID(21), OpSetID(22)));
    registerAdapter(
        std::make_unique<CompatibleAdapter>("LpNormalization", OpSetID(21), OpSetID(22)));
    ...
    /******** 22 -> 21 ********/
    registerAdapter(std::make_unique<TypeRestriction>("EyeLike", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("AveragePool", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("MaxPool", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("RandomUniform", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("RandomNormal", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("RandomNormalLike", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("RandomUniformLike", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("Multinomial", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("Bernoulli", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("ThresholdedRelu", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Selu", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Elu", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Mish", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("HardSigmoid", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("HardSwish", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("Softsign", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("Softplus", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Sin", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Cos", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Tan", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Asin", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Acos", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Atan", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Sinh", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Cosh", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Asinh", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Acosh", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Atanh", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Round", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Det", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("NegativeLogLikelihoodLoss", OpSetID(22),
                                                      OpSetID(21), bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("MaxUnpool", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("LpPool", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("MaxRoiPool", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("Conv", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("ConvTranspose", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("DeformConv", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("GlobalAveragePool", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("GlobalLpPool", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("InstanceNormalization", OpSetID(22),
                                                      OpSetID(21), bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("LpNormalization", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("Dropout", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("RoiAlign", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("RNN", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("GRU", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(
        std::make_unique<TypeRestriction>("LSTM", OpSetID(22), OpSetID(21), bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("GridSample", OpSetID(22), OpSetID(21),
                                                      bfloat16_not_allowed));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ConstantOfShape", OpSetID(22), OpSetID(23)));
    registerAdapter(
        std::make_unique<CompatibleAdapter>("DequantizeLinear", OpSetID(22), OpSetID(23)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("QuantizeLinear", OpSetID(22), OpSetID(23)));
    ...
    /******** 23 -> 22 ********/
    const std::vector<TensorProto_DataType> ir11_types_not_in_ir10 = {
        TensorProto_DataType_FLOAT4E2M1};
    registerAdapter(std::make_unique<TypeRestriction>("Cast", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("CastLike", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("Constant", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("ConstantOfShape", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("DequantizeLinear", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("Flatten", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("Identity", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(
        std::make_unique<TypeRestriction>("If", OpSetID(23), OpSetID(22), ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("Loop", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(
        std::make_unique<TypeRestriction>("Pad", OpSetID(23), OpSetID(22), ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("QuantizeLinear", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("Reshape", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("Scan", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("Shape", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("Size", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("Squeeze", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("Transpose", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    registerAdapter(std::make_unique<TypeRestriction>("Unsqueeze", OpSetID(23), OpSetID(22),
                                                      ir11_types_not_in_ir10));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ConstantOfShape", OpSetID(23), OpSetID(24)));
    registerAdapter(
        std::make_unique<CompatibleAdapter>("DequantizeLinear", OpSetID(23), OpSetID(24)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("QuantizeLinear", OpSetID(23), OpSetID(24)));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("SplitToSequence", OpSetID(23), OpSetID(24)));
    ...
    registerAdapter(std::make_unique<TypeRestriction>("Cast", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("CastLike", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("Constant", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("ConstantOfShape", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("DequantizeLinear", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("Flatten", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("Identity", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(
        std::make_unique<TypeRestriction>("If", OpSetID(24), OpSetID(23), ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("Loop", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(
        std::make_unique<TypeRestriction>("Pad", OpSetID(24), OpSetID(23), ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("QuantizeLinear", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("Reshape", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("Scan", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("Shape", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("Size", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("Squeeze", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("Transpose", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));
    registerAdapter(std::make_unique<TypeRestriction>("Unsqueeze", OpSetID(24), OpSetID(23),
                                                      ir12_types_not_in_ir11));

    registerAdapter(
        std::make_unique<TypeRestriction>("TopK", OpSetID(24), OpSetID(23), bfloat16_not_allowed));
    registerAdapter(std::make_unique<TypeRestriction>("SplitToSequence", OpSetID(24), OpSetID(23),
                                                      bfloat16_not_allowed));
    ...
    registerAdapter(
        std::make_unique<CompatibleAdapter>("ConstantOfShape", OpSetID(24), OpSetID(25)));
    registerAdapter(
        std::make_unique<CompatibleAdapter>("DequantizeLinear", OpSetID(24), OpSetID(25)));
    ...
    registerAdapter(std::make_unique<TypeRestriction>("CastLike", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("Constant", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("ConstantOfShape", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("DequantizeLinear", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("Flatten", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("Identity", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("Reshape", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("Shape", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("Size", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(
        std::make_unique<TypeRestriction>("If", OpSetID(25), OpSetID(24), ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("Loop", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("Scan", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(
        std::make_unique<TypeRestriction>("Pad", OpSetID(25), OpSetID(24), ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("Squeeze", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("Transpose", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
    registerAdapter(std::make_unique<TypeRestriction>("Unsqueeze", OpSetID(25), OpSetID(24),
                                                      ir13_types_not_in_ir12));
