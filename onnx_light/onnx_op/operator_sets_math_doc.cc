...
std::string MakeMaxDoc(int since_version) {
  if (since_version <= 6) {
    return R"DOC(Element-wise max of each of the input tensors. All inputs and outputs must
have the same shape and data type.
)DOC";
  }
  return R"DOC(Element-wise max of each of the input tensors (with Numpy-style broadcasting support).
All inputs and outputs must have the same data type.
...
std::string MakeMinDoc(int since_version) {
  if (since_version <= 6) {
    return R"DOC(Element-wise min of each of the input tensors. All inputs and outputs must
have the same shape and data type.
)DOC";
  }
  return R"DOC(Element-wise min of each of the input tensors (with Numpy-style broadcasting support).
All inputs and outputs must have the same data type.
