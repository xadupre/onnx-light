...
matrix-multiplication and normalization/activation patterns, and this pull
request adds the final 9 attention patterns.
...
#. **Rotary embedding and attention functions (done in this pull request).**
...
* This pull request: rotary embedding, causal masks, caches, attention
  functions, and grouped-query attention.
