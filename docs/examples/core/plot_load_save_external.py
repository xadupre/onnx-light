...
# ``num_threads`` greater than 1 (or a negative value to pick a sensible
# default based on the number of CPU cores) to enable the worker pool.
# The ``min_block_size`` parameter prevents spawning threads for tiny
# tensors.
