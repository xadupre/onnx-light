...
class TestBackendDocs(ExtTestCase):
    def test_api_index_references_backend(self):
        """Verifies that the API index links the backend documentation."""
    ...
    def test_backend_index_lists_random_module(self):
        """Verifies that the backend API index lists the random submodule."""
        backend_index = (
    ...
    def test_backend_random_page_exists(self):
        """Verifies that the backend random API page exists and is wired to automodule."""
        random_page = (
