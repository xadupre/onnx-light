 ...
 *                     Pass a populated registry (e.g. from onnx_gradient's
 *                     DefaultGradRegistry, or a custom one built with
 *                     RegisterGradientFunction) to support specific operators.
