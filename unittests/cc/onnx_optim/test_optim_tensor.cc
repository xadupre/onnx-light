...
TEST(OnnxOptimValueInfo, ToValueInfoWritesDeviceMetadata) {
  ...
  EXPECT_EQ(std::string(vi.metadata_props()[0].key()), onnx_optim::kValueInfoDeviceMetadataKey);
...
TEST(OnnxOptimValueInfo, ToValueInfoUpdatesExistingDeviceMetadataInPlace) {
  ...
  EXPECT_EQ(std::string(vi.metadata_props()[1].key()), onnx_optim::kValueInfoDeviceMetadataKey);
