...
The kernels live under ``onnx_light/onnx_extensions/onnx_kernels/kernels/<group>/`` and
...
:doc:`../api/cpp/onnx_extensions/onnx_kernels/index` for the full C++ API reference.
