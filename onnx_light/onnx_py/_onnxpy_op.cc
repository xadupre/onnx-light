...
void AddOnnxPyOp(nb::module_ &m) {
  ...
  nb::enum_<onnx_proto::TensorType>(onnx_op_mod, "TensorType",
      ...
      .value("kSeqBfloat16", onnx_proto::TensorType::kSeqBfloat16)
      .value("kSeqFloat8e4m3fn", onnx_proto::TensorType::kSeqFloat8e4m3fn)
      .value("kSeqFloat8e4m3fnuz", onnx_proto::TensorType::kSeqFloat8e4m3fnuz)
      .value("kSeqFloat8e5m2", onnx_proto::TensorType::kSeqFloat8e5m2)
      .value("kSeqFloat8e5m2fnuz", onnx_proto::TensorType::kSeqFloat8e5m2fnuz)
      .value("kSeqFloat8e8m0", onnx_proto::TensorType::kSeqFloat8e8m0)
      .value("kSeqFloat4e2m1", onnx_proto::TensorType::kSeqFloat4e2m1)
      .value("kSeqUint4", onnx_proto::TensorType::kSeqUint4)
      .value("kSeqInt4", onnx_proto::TensorType::kSeqInt4)
      .value("kSeqUint2", onnx_proto::TensorType::kSeqUint2)
      .value("kSeqInt2", onnx_proto::TensorType::kSeqInt2)
      .value("kSeqFloat6e2m3", onnx_proto::TensorType::kSeqFloat6e2m3)
      .value("kSeqFloat6e3m2", onnx_proto::TensorType::kSeqFloat6e3m2)
      ...
      .value("kOptSeqBfloat16", onnx_proto::TensorType::kOptSeqBfloat16)
      .value("kOptSeqFloat8e4m3fn", onnx_proto::TensorType::kOptSeqFloat8e4m3fn)
      .value("kOptSeqFloat8e4m3fnuz", onnx_proto::TensorType::kOptSeqFloat8e4m3fnuz)
      .value("kOptSeqFloat8e5m2", onnx_proto::TensorType::kOptSeqFloat8e5m2)
      .value("kOptSeqFloat8e5m2fnuz", onnx_proto::TensorType::kOptSeqFloat8e5m2fnuz)
      .value("kOptSeqFloat8e8m0", onnx_proto::TensorType::kOptSeqFloat8e8m0)
      .value("kOptSeqFloat4e2m1", onnx_proto::TensorType::kOptSeqFloat4e2m1)
      .value("kOptSeqUint4", onnx_proto::TensorType::kOptSeqUint4)
      .value("kOptSeqInt4", onnx_proto::TensorType::kOptSeqInt4)
      .value("kOptSeqUint2", onnx_proto::TensorType::kOptSeqUint2)
      .value("kOptSeqInt2", onnx_proto::TensorType::kOptSeqInt2)
      .value("kOptSeqFloat6e2m3", onnx_proto::TensorType::kOptSeqFloat6e2m3)
      .value("kOptSeqFloat6e3m2", onnx_proto::TensorType::kOptSeqFloat6e3m2)
      ...
      .value("kOptBfloat16", onnx_proto::TensorType::kOptBfloat16)
      .value("kOptFloat8e4m3fn", onnx_proto::TensorType::kOptFloat8e4m3fn)
      .value("kOptFloat8e4m3fnuz", onnx_proto::TensorType::kOptFloat8e4m3fnuz)
      .value("kOptFloat8e5m2", onnx_proto::TensorType::kOptFloat8e5m2)
      .value("kOptFloat8e5m2fnuz", onnx_proto::TensorType::kOptFloat8e5m2fnuz)
      .value("kOptFloat8e8m0", onnx_proto::TensorType::kOptFloat8e8m0)
      .value("kOptFloat4e2m1", onnx_proto::TensorType::kOptFloat4e2m1)
      .value("kOptUint4", onnx_proto::TensorType::kOptUint4)
      .value("kOptInt4", onnx_proto::TensorType::kOptInt4)
      .value("kOptUint2", onnx_proto::TensorType::kOptUint2)
      .value("kOptInt2", onnx_proto::TensorType::kOptInt2)
      .value("kOptFloat6e2m3", onnx_proto::TensorType::kOptFloat6e2m3)
