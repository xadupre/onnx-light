...
TEST(OnnxOptimShapeAdam, DirectCallRejectsWrongOpType) {
  ...
  core::shapes::ShapesContext ctx;
  EXPECT_THROW(onnx_shapes::shapes::training::ComputeShapeAdam(ctx, node), std::invalid_argument);
}
...
TEST(OnnxOptimShapeAdagrad, DirectCallRejectsWrongOpType) {
  ...
  core::shapes::ShapesContext ctx;
  EXPECT_THROW(onnx_shapes::shapes::training::ComputeShapeAdagrad(ctx, node),
...
TEST(OnnxOptimShapeMomentum, DirectCallRejectsWrongOpType) {
  ...
  core::shapes::ShapesContext ctx;
  EXPECT_THROW(onnx_shapes::shapes::training::ComputeShapeMomentum(ctx, node),
               std::invalid_argument);
}
