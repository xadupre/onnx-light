...
ONNX_OPERATOR_SET_SCHEMA(Greater, 9,
                         OpSchema()
...
ONNX_OPERATOR_SET_SCHEMA(Less, 9,
                         OpSchema()
...
detailed description of the broadcasting rules.
    ...
    schema.Attr("axis", "If set, defines the broadcast dimensions.", AttributeProto::INT,
                OPTIONAL_VALUE);
...
ONNX_OPERATOR_SET_SCHEMA(And, 1,
                         OpSchema()
...
ONNX_OPERATOR_SET_SCHEMA(Xor, 1,
                         OpSchema()
...
ONNX_OPERATOR_SET_SCHEMA(Greater, 1,
                         OpSchema()
...
ONNX_OPERATOR_SET_SCHEMA(Less, 1,
                         OpSchema()
...
ONNX_OPERATOR_SET_SCHEMA(Equal, 1,
                         OpSchema()
...
ONNX_OPERATOR_SET_SCHEMA(Equal, 7,
                         OpSchema()
...
ONNX_OPERATOR_SET_SCHEMA(Greater, 7,
                         OpSchema()
...
ONNX_OPERATOR_SET_SCHEMA(Less, 7,
                         OpSchema()
...
ONNX_OPERATOR_SET_SCHEMA(LessOrEqual, 12,
                         OpSchema()
...
ONNX_OPERATOR_SET_SCHEMA(GreaterOrEqual, 12,
                         OpSchema()
