...
Tensor ReduceProd::operator()(RuntimeContext *rt, const Tensor &data, bool keepdims,
...
Tensor ReduceProd::operator()(RuntimeContext *rt, const Tensor &data, const Tensor &axes,
