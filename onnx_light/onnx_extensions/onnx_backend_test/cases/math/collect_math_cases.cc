...
void CollectMathTestCases(std::vector<TestCase> &registry, const std::string &op_type,
  ...
  static const OpRegisterModeMap kEntries = {
      ...
      {"HardSigmoid", &RegisterHardSigmoidCases},
      {"HardSwish", &RegisterHardSwishCases},
      {"Hardmax", &RegisterHardmaxCases},
      {"Shrink", &RegisterShrinkCases},
      {"Exp", &RegisterExpCases},
      {"Log", &RegisterLogCases},
      {"Gemm", &RegisterGemmCases},
      {"MatMul", &RegisterMatMulCases},
      {"MatMulInteger", &RegisterMatMulIntegerCases},
      ...
      {"LogSoftmax", &RegisterLogSoftmaxCases},
      ...
      {"Relu", &RegisterReluCases},
      {"LeakyRelu", &RegisterLeakyReluCases},
      {"Elu", &RegisterEluCases},
      {"Celu", &RegisterCeluCases},
      {"Gelu", &RegisterGeluCases},
      {"Selu", &RegisterSeluCases},
      {"Swish", &RegisterSwishCases},
      {"SwiGLU", &RegisterSwiGLUCases},
