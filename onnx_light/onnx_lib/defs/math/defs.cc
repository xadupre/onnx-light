...
ONNX_OPERATOR_SET_SCHEMA(Mod, 28,
                         OpSchema()
                             .SetDoc(kDoc_Mod_ver28)
                             .Attr("fmod",
                                   "Whether the operator should use floor (0) or truncation (1) to "
                                   "calculate the quotient.",
                                   AttributeProto::INT, static_cast<int64_t>(0))
                             .Input(0, "A", "Dividend tensor", "T", OpSchema::Single, true, 1,
                                    OpSchema::Differentiable)
...
ONNX_OPERATOR_SET_SCHEMA(
    Gemm, 13,
    OpSchema()
        .SetDoc(GET_OP_DOC_STR(std::string(kDoc_Gemm_ver13) +
