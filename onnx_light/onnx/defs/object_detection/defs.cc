...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Attr("coordinate_transformation_mode",
              ...
              "Use the value 'half_pixel' to pixel shift the input coordinates by -0.5 (the "
              "recommended behavior). "
              "Use the value 'output_half_pixel' to omit the pixel shift for the input (use this "
              "for a "
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Input(1, "scores",
               ...
               "tensor(float)")
        .Input(2, "max_output_boxes_per_class",
        ...
        .Attr("center_point_box",
              ...
              "0 - the box data is supplied as [y1, x1, y2, x2] where (y1, x1) and (y2, x2) are "
              "the coordinates of any diagonal pair of box corners "
              "and the coordinates can be provided as normalized (i.e., lying in the interval [0, "
              "1]) or absolute. Mostly used for TF models. "
              "1 - the box data is supplied as [x_center, y_center, width, height]. Mostly used "
              "for Pytorch models.",
              AttributeProto::INT, static_cast<int64_t>(0))
