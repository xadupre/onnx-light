...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .TypeConstraint("T1", OpSchema::all_non_complex_tensor_types_ir14(),
                        "Constrain input types. Casting from complex is not supported.")
        .TypeConstraint("T2", OpSchema::all_non_complex_tensor_types_ir14(),
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Attr("to",
              ...
              AttributeProto::INT)
        .Input(0, "input", "Input tensor to be bitcast.", "T1", OpSchema::Single, true, 1,
               OpSchema::NonDifferentiable)
        .Output(0, "output", "Output tensor with the same shape as the input.", "T2",
                OpSchema::Single, true, 1, OpSchema::NonDifferentiable)
        .TypeConstraint("T1", OpSchema::all_non_string_tensor_types_ir13(),
                        "Constrain input types. Bitcasting from string is not supported.")
        .TypeConstraint("T2", OpSchema::all_non_string_tensor_types_ir13(),
        ...
        .TypeAndShapeInferenceFunction([](InferenceContext &ctx) {
          ...
          if (input_type && input_type->has_tensor_type()) {
            ...
            if (to_attr) {
              ...
              const uint32_t input_element_bit_size =
                  FixedBitWidth(static_cast<TensorProto::DataType>(input_element_type));
              const uint32_t output_element_bit_size =
                  FixedBitWidth(static_cast<TensorProto::DataType>(output_element_type));
              if (input_element_bit_size != 0 && output_element_bit_size != 0 &&
                  input_element_bit_size != output_element_bit_size) {
                fail_shape_inference("BitCast requires input and output types to have the same "
                                     "bit-width, but input type has ",
                                     input_element_bit_size, " bits and output type has ",
                                     output_element_bit_size, " bits.");
              }
            }
          }
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Input(0, "inputs", "List of tensors for concatenation", "T", OpSchema::Variadic, true, 1,
               OpSchema::Differentiable)
        .Output(0, "concat_result", "Concatenated tensor", "T", OpSchema::Single, true, 1,
                OpSchema::Differentiable)
        ...
        .TypeAndShapeInferenceFunction([](InferenceContext &ctx) {
          ...
          if (ctx.hasInput(1)) { //'split' is input
            ...
            if (num_outputs_attr) {
              ...
              fail_shape_inference(
                  "Neither 'split' input nor 'num_outputs' attribute has been given");
            }
          }
          for (size_t i = 0; i < ctx.getNumOutputs(); i++) {
            *ctx.getOutputType(i)->mutable_tensor_type()->mutable_shape() = shape;
...
static void processSliceInputs(const int64_t input_dim_size_or_value, int64_t &start, int64_t &end,
                               int64_t step) {
  // process step
  if (step == 0) {
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Input(0, "data", "Tensor of data to extract slices from.", "T", OpSchema::Single, true, 1,
               OpSchema::Differentiable)
        ...
        .Input(4, "steps",
               ...
               "Defaults to 1s.",
               "Tind", OpSchema::Optional, true, 1, OpSchema::NonDifferentiable)
        .Output(0, "output", "Sliced data tensor.", "T", OpSchema::Single, true, 1,
                OpSchema::Differentiable)
        .TypeConstraint("T", OpSchema::all_tensor_types_ir4(),
                        "Constrain input and output types to all tensor types.")
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Input(0, "data", "Tensor of rank r >= 1.", "T", OpSchema::Single, true, 1,
               OpSchema::Differentiable)
        .Input(1, "indices", "Tensor of rank q >= 1.", "tensor(int64)", OpSchema::Single, true, 1,
               OpSchema::NonDifferentiable)
        .Input(2, "updates", "Tensor of rank q + r - indices_shape[-1] - 1.", "T", OpSchema::Single,
               true, 1, OpSchema::Differentiable)
        .Output(0, "output", "Tensor of rank r >= 1.", "T", OpSchema::Single, true, 1,
                OpSchema::Differentiable)
        .TypeConstraint("T", OpSchema::all_tensor_types_ir4(),
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Input(1, "indices",
               ...
               "Tind", OpSchema::Single, true, 1, OpSchema::NonDifferentiable)
        .Output(0, "output", "Tensor of rank q + (r - 1).", "T", OpSchema::Single, true, 1,
                OpSchema::Differentiable)
        .TypeConstraint("T", OpSchema::all_tensor_types_ir4(),
                        "Constrain input and output types to any tensor type.")
        .TypeConstraint("Tind", {"tensor(int32)", "tensor(int64)"},
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Input(1, "indices",
               ...
               "values are out of bounds.",
               "Tind", OpSchema::Single, true, 1, OpSchema::NonDifferentiable)
        .Output(0, "output", "Tensor of the same shape as indices.", "T", OpSchema::Single, true, 1,
                OpSchema::Differentiable)
        .TypeConstraint("T", OpSchema::all_tensor_types_ir4(),
                        "Constrain input and output types to any tensor type.")
        .TypeConstraint("Tind", {"tensor(int32)", "tensor(int64)"},
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Input(0, "input", "Input tensor of any shape.", "T", OpSchema::Single, true, 1,
               OpSchema::Differentiable)
        .Input(1, "repeats",
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Attr("coordinate_transformation_mode",
              Resize_ver19_attr_coordinate_transformation_mode_doc, AttributeProto::STRING,
        ...
        .Attr("keep_aspect_ratio_policy", Resize_ver19_attr_keep_aspect_ratio_policy_doc,
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Input(0, "theta",
               ...
               "T1", OpSchema::Single, true, 1, OpSchema::NonDifferentiable)
        .Input(1, "size",
               "the target output image size (N, C, H, W) for 2D or (N, C, D, H, W) for 3D", "T2",
               OpSchema::Single, true, 1, OpSchema::NonDifferentiable)
        .Output(0, "grid",
        ...
        .TypeAndShapeInferenceFunction([](InferenceContext &ctx) {
          ...
          if (size_length != 4 && size_length != 5) {
            fail_shape_inference("Length of input 'size' is ", size_length,
                                 ". It must be 4 for 2D or 5 for 5D.");
          }
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .TypeConstraint("T1", OpSchema::all_float_types_ir9(),
...
ONNX_OPERATOR_SET_SCHEMA(NonZero, 13,
                         OpSchema()
                             .SetDoc(kDoc_NonZero_ver9)
                             .Input(0, "X", "input", "T", OpSchema::Single, true, 1,
                                    OpSchema::NonDifferentiable)
                             .Output(0, "Y", "output", "tensor(int64)", OpSchema::Single, true, 1,
                                     OpSchema::NonDifferentiable)
                             .TypeConstraint("T", OpSchema::all_tensor_types_ir4(),
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Input(1, "indices",
               ...
               "along axis of size s. It is an error if any of the index values are out of bounds.",
               "tensor(int64)", OpSchema::Single, true, 1, OpSchema::NonDifferentiable)
        .Output(0, "output", "Tensor of rank q + r - indices_shape[-1] - 1.", "T", OpSchema::Single,
                true, 1, OpSchema::Differentiable)
        .TypeConstraint("T", OpSchema::all_tensor_types_ir4(),
                        "Constrain input and output types to any tensor type.")
        .TypeAndShapeInferenceFunction([](InferenceContext &ctx) {
...
ONNX_OPERATOR_SET_SCHEMA(Pad, 25,
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Attr("upper",
              ...
              "true.",
              AttributeProto::INT, static_cast<int64_t>(1))
        .Input(0, "input", "Input tensor of rank 2 or higher.", "T", OpSchema::Single, true, 1,
               OpSchema::Differentiable)
        .Input(1, "k",
               ...
               "tensor(int64)", OpSchema::Optional, true, 1, OpSchema::NonDifferentiable)
        .Output(0, "output", "Output tensor of the same type and shape as the input tensor.", "T",
                OpSchema::Single, true, 1, OpSchema::Differentiable)
        .TypeConstraint("T", OpSchema::all_tensor_types_ir4(),
                        "Constrain input and output types to all tensor types.")
        .TypeAndShapeInferenceFunction([](InferenceContext &ctx) {
...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Input(0, "input_data", "Input to extract the centered crop from.", "T", OpSchema::Single,
               true, 1, OpSchema::Differentiable)
        .Input(1, "shape", "1-D tensor representing the cropping window dimensions.", "Tind",
               OpSchema::Single, true, 1, OpSchema::NonDifferentiable)
        .Output(0, "output_data", "Output data.", "T", OpSchema::Single, true, 1,
                OpSchema::Differentiable)
        .Attr("axes",
        ...
        .TypeAndShapeInferenceFunction([](InferenceContext &ctx) {
          ...
          if (shape.size() != axes.size()) {
            fail_shape_inference("Number of elements of input 'shape' (", shape.size(),
          ...
          if (hasInputShape(ctx, 0) && hasInputShape(ctx, 1)) {
            ...
            if (past_cache_rank != update_rank) {
              fail_shape_inference(
                  ...
                  past_cache_rank, ", update_rank=", update_rank);
            }
