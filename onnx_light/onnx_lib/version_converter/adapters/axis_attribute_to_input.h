...
public:
  AxisAttributeToInput(const std::string &op_name, const OpSetID &initial, const OpSetID &target,
                       size_t axis_index, int64_t default_axis)
...
private:
  ...
  void AttrToInput(const std::shared_ptr<Graph> &graph, Node *node, int64_t axis,
