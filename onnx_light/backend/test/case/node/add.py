...
"""Python-defined backend test cases for the ``Add`` operator.

These cases mirror those exported by ``onnx.backend.test.case.node.add`` in
the upstream :mod:`onnx` package, adapted to use :mod:`onnx_light` instead.
"""
