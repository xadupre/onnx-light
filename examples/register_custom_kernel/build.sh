...
#   bash examples/register_custom_kernel/build.sh [install-prefix] [lib-build-dir] [example-build-dir]
...
INSTALL_PREFIX="${1:-${REPO_ROOT}/build/install-register-custom-kernel}"
LIB_BUILD_DIR="${2:-${REPO_ROOT}/build/register-custom-kernel-lib}"
EXAMPLE_BUILD_DIR="${3:-${REPO_ROOT}/build/register-custom-kernel-example}"
...
echo
echo "Example binary:"
echo "  ${EXAMPLE_BUILD_DIR}/register_custom_kernel"
