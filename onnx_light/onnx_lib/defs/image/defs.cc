...
ONNX_OPERATOR_SET_SCHEMA(
    ...
    OpSchema()
        ...
        .Attr("pixel_format", "Pixel format. Can be one of \"RGB\", \"BGR\", or \"Grayscale\".",
              AttributeProto::STRING, std::string("RGB"))
        .Input(0, "encoded_stream", "Encoded stream", "T1", OpSchema::Single, true, 1,
               OpSchema::NonDifferentiable)
        .Output(0, "image", "Decoded image", "T2", OpSchema::Single, true, 1,
                OpSchema::NonDifferentiable)
