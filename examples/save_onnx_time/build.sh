...
#   bash examples/save_onnx_time/build.sh [install-prefix] [lib-build-dir] [example-build-dir]
...
INSTALL_PREFIX="${1:-${REPO_ROOT}/build/install-save-onnx-time}"
LIB_BUILD_DIR="${2:-${REPO_ROOT}/build/save-onnx-time-lib}"
EXAMPLE_BUILD_DIR="${3:-${REPO_ROOT}/build/save-onnx-time-example}"
...
echo
echo "Example binary:"
echo "  ${EXAMPLE_BUILD_DIR}/save_onnx_time"
