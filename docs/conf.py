...
epkg_dictionary = {
    ...
    "onnx_light/onnx_extensions/kernels/kernels": (
        "https://github.com/xadupre/onnx-light/tree/main/onnx_light/onnx_extensions/kernels/kernels"
    ),
    "onnx_light/onnx_extensions/kernels/run_nodes.cc": (
        "https://github.com/xadupre/onnx-light/blob/main/onnx_light/onnx_extensions/kernels/run_nodes.cc"
    ),
