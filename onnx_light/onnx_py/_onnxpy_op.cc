...
void AddOnnxPyOp(nb::module_ &m) {
  ...
  nb::enum_<onnx_op::TensorType>(onnx_op_mod, "TensorType",
      ...
      .value("kMapStringInt64", onnx_op::TensorType::kMapStringInt64)
      .value("kMapInt64String", onnx_op::TensorType::kMapInt64String)
      .value("kMapInt64Float", onnx_op::TensorType::kMapInt64Float)
      .value("kMapInt64Double", onnx_op::TensorType::kMapInt64Double)
      .value("kMapStringFloat", onnx_op::TensorType::kMapStringFloat)
      .value("kMapStringDouble", onnx_op::TensorType::kMapStringDouble)
