...
TEST(OnnxOptimShapesMathHardSigmoid, PropagatesTypeAndShape) {
  ...
  onnx_shapes::shapes::math::ComputeShapeHardSigmoid(ctx, node, "X");
...
TEST(OnnxOptimShapesMathHardSwish, PropagatesTypeAndShape) {
  ...
  onnx_shapes::shapes::math::ComputeShapeHardSwish(ctx, node, "X");
...
TEST(OnnxOptimShapesMathHardmax, PropagatesTypeAndShapeAndAcceptsValidAxis) {
  ...
  onnx_shapes::shapes::math::ComputeShapeHardmax(ctx, node, "input");
...
TEST(OnnxOptimShapesMathHardmax, RejectsOutOfRangeAxis) {
  ...
  EXPECT_THROW(onnx_shapes::shapes::math::ComputeShapeHardmax(ctx, node, "input"), std::exception);
}
