...
ONNX_API inline void RegisterOnnxOperatorSetSchema() {
  ...
  RegisterOpSetSchema<OpSet_Onnx_ver3>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver4>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver5>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver6>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver7>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver8>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver9>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver10>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver11>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver12>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver13>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver14>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver15>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver16>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver17>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver18>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver19>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver20>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver21>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver22>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver23>(0, false);
  RegisterOpSetSchema<OpSet_Onnx_ver24>(0, false);
  ...
  RegisterOpSetSchema<OpSet_Onnx_ver29>(0, false);
  // 0 means all versions of ONNX schema have been loaded
  OpSchemaRegistry::SetLoadedSchemaVersion(0);
}

ONNX_API inline void RegisterOnnxOperatorSetSchema(int target_version,
                                                   bool fail_duplicate_schema = true) {
  // Update here if opset_version bumps
  // These calls for schema registration here are required to be in descending order for this to
  // work correctly
  //
