...
- Propagate onnx/onnx#8125: remove dead shape-inference declarations, make `GenerateSymbolicShape` TU-local, deduplicate `resizeShapeInferenceHelper`, and drop redundant copy/assign macro from `ir.h`
