...
public:
  ...
  /// Appends root-graph feedback wiring; validates names, paths and types during export.
  /// An empty field path selects the whole value. No state payload is stored.
